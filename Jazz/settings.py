...
SECRET_KEY = 'django-insecure-1y41apx913a%i1zu&g$ql!^wr(jw7b-!h-ak6#@o!h9pz*tvxa'
...
JAZZMIN_SETTINGS = {
    ...
    "navigation_expanded": False,  # if set to false then for each model there will be a drop down on click
